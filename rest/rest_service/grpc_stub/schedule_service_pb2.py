...
_SCHEDULER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='AddClosureSchedule',
    full_name='scheduler.Scheduler.AddClosureSchedule',
    index=1,
    containing_service=None,
    input_type=_REQUEST,
    output_type=_RESPONSE,
