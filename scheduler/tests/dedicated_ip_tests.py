...
class TestDedicated:
    ...
    @patch('scheduler_service.utils.ipam.Ipam')
    @patch.object(Ipam, 'get_properties_for_ip')
    def test_is_dedicated_ip(self, get_properties_for_ip, ipam):
    ...
    @patch('scheduler_service.utils.ipam.Ipam')
    @patch.object(Ipam, 'get_properties_for_ip')
    def test_is_not_dedicated_ip(self, get_properties_for_ip, ipam):
